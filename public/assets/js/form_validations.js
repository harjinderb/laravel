	    ...
	    $("#subscribe").change(function () {
           ...
           $(".next").click(function(){
			...
			$('.previous').click(function(){
             ...
             $('.select2', "#analysis").change(function () {
                $('#analysis').validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
            });
             ...
             $('.select2', "#contact").change(function () {
                $('#contact').validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
            });
            ...
            //////////////////end popup//////////////////////////
             ...
             $('.select2', "#userRegister").change(function () {
                $('#userRegister').validate().element($(this)); //revalidate the chosen dropdown value and show error or success message for the input
            });
