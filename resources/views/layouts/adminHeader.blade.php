...
<div class="header navbar navbar-inverse ">
  ...
  <div class="navbar-inner">
    <div class="header-seperation">
      ...
      <!-- BEGIN LOGO -->
      <a href="{{ URL :: to('dashboard') }}"><img src="{{ URL :: to('assets/img/logo.png') }}" class="logo" alt=""  data-src="{{ URL :: to('assets/img/logo.png') }}" data-src-retina="{{ URL :: to('assets/img/logo.png') }}" width="106" height="21"/></a>
      <!-- END LOGO -->
      <ul class="nav pull-right notifcation-center">
        <li class="dropdown" id="header_task_bar"> <a href="{{ URL :: to('dashboard') }}" class="dropdown-toggle active" data-toggle="">
    ...
    <div class="header-quick-nav" >
      ...
      <div class="pull-left">
        ...
        <ul class="nav quick-section">
          <li class="quicklinks"> <a href="javascript;" onclick="location.reload(true); return false;" class="" title="Reload Page">
      ...
      <div class="pull-right">
        <div class="chat-toggler"> <a href="#" class="dropdown-toggle" id="my-task-list" data-placement="bottom"  data-content='' data-toggle="dropdown" data-original-title="Notifications">
          <div class="user-details">
            <div class="username"> <span class="badge badge-important">3</span> {{ Auth::user()->FirstName }} <span class="bold">{{ Auth::user()->LastName }}</span> </div>
          </div>
