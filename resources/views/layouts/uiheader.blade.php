...
<img src="{{URL :: to('assets/front/img/bg/BackstretchSkyline dark.jpg') }}"   alt="Home page"  data-bgfit="cover" data-bgposition="right center" data-bgrepeat="no-repeat" id="headerbanner">
