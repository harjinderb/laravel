			...
			<div class="p-t-60 p-b-60">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						{!! Form::open(array('url' => '#','id'=>'subscribe','class'=>'form-no-horizontal-spacing')) !!}
...
<p class="text-center">Electronic Payment Systems &copy; 2014 | EPS is a registered ISO/MSP of Esquire Bank, 320 Old Country Road Garden City NY 11530 | <a href="{{ URL::to('privacy-policy')}}">Privacy Policy</a> | <a href="{{ URL::to('terms_and_conditions')}}">Terms &amp; Conditions</a></p>
</div>
	<!------------Form Start----------->
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		  ...
		  <div class="modal-content">
			<div class="modal-header">
			  ...
			  <br>
				...
				{!! Form::open(array('url' => '#','id'=>'analysis','class'=>'form-no-horizontal-spacing')) !!}
		...
		<div class="row form-row">
				...
				<div class="col-md-12">
					...
					<div class="input-with-icon  right"><i class=""></i>
					{!! Form::text('others', '' , ['class'=>'form-control', 'id'=>'others','placeholder'=>'']) !!}
					</div>
				</div>
				</div>
